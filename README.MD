...
- In examples/LVGL/SimpleWatch of branch "hrg", you can find an animated Mickey Mouse watch.
  It is localized to German/Switzerland and does synchronize time from internet using NTP.
